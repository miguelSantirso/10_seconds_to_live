package ten_seconds_to_live.com.five_ants.ten_secs 
{
	...
	public class GameTime extends EventDispatcher implements IUpdateable
	{
		...
		public function startSlowmo(slowmoRate:Object = null, slowmoDefault:Object = null):void
		{
			if (slowmoRate) {
				if (slowmoRate as Number)
					_timeSpeedSlowmo =  _timeSpeedDefault * (slowmoRate as Number);
			}
			
			if (slowmoDefault) {
				if (slowmoDefault as Number)
					_slowmoDefault = slowmoDefault as Number;
			}
