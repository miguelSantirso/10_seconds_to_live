package ten_seconds_to_live.com.five_ants.ten_secs.realities 
{
	...
	public class MainReality implements IRealityConfig
	{
		...
		public function scriptEntities(logic:RealityLogic):void
		{
			...
			object("_roomTable").addActionSuccess(new ShowPopUp(Items.NOTE_AND_WATCH, "Piece Of Paper", "\"Thereís a lethal poison spreading in your body. Youíll die at 15:00 because youíll never find the antidote.\" Thereís only 10 seconds left!"));
			...
			object("_statue").addActionNoItemNoKnowledge(new ShowPopUp(Items.STATUE, "Statue", "This is the statue I sent carving for our anniversary. There‚Äôs a date written on the foot. ‚ÄúFebruary 16th.‚Äù Wasn‚Äôt she beautiful...?"));
			...
			object("_catfood").addActionSuccess(new ShowPopUp(Items.CATNIP, "Catnip", "Hereís the Catnip!"));
